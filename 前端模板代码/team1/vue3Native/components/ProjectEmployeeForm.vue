  ...
  <a-spin :spinning="confirmLoading">
    <a-form ref="formRef" class="antd-modal-form" :labelCol="labelCol" :wrapperCol="wrapperCol">
      <a-row>
        ...
        <a-col :span="24">
          <a-form-item label="在岗日期" v-bind="validateInfos.start">
		        <a-date-picker placeholder="请选择在岗日期" v-model:value="formData.start" value-format="YYYY-MM-DD"  style="width: 100%" :disabled="disabled"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item label="离岗日期" v-bind="validateInfos.end">
		        <a-date-picker placeholder="请选择离岗日期" v-model:value="formData.end" value-format="YYYY-MM-DD"  style="width: 100%" :disabled="disabled"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">
...
<script lang="ts" setup>
  ...
  import { saveOrUpdate } from '../ProjectEmployee.api';
  ...
  const validatorRules = {
    ...
    post: [{ required: true, message: '请输入岗位!'},],
